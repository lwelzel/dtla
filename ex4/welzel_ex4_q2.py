...
# just to flex
im3 =ax3.imshow(sh.histogram_equalization(img))
divider3 = make_axes_locatable(ax3)
cax3 = divider3.append_axes("right", size="10%", pad=0.05)
cbar3 = plt.colorbar(im3,cax3)
ax3.set_title('Histogram equalized.', fontsize=8)

im4 =ax4.contourf(np.exp(img), levels=10, cmap='gist_heat')
